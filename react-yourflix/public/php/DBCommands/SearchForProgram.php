<?php
    ...
    function SearchDatabase($DB_CONN, $QUERY)
    {
        ...
        $_select = 'SELECT Program.Program_Name, Program.First_Content, Program.First_Folder, Program.Num_Content, Program_Image.Img_Location, Program.Program_Last_Updated ';
